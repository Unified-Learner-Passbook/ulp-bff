...
const AADHAAR_DID_URL =
  process.env.AADHAAR_DID_URL ||
  'https://ulp.uniteframework.io/ulp-bff/v1/sso/student/getdid';
const registry_url =
  process.env.REGISTRY_URL || 'https://ulp.uniteframework.io/registry/';
...
export class CredentialsService {
  ...
  async issueBulkCredential(
    credentialPlayload: CredentialDto,
    schemaId: string,
    response: Response,
  ) {
